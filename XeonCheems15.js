...
{"header":"قـائـمـة الـتـحـمـيـل ⏬",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 التحميل",
"description":"",
"id":"${prefix}downloadmenu"},
{"header":"قـائـمـة الالـعـاب 🎮",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 العاب",
"description":"",
"id":"${prefix}gamemenu"},
{"header":"قـائـمـة الـتـرفـيـة 🕹️",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 الترفيه",
"description":"",
"id":"${prefix}funmenu"},
{"header":"قـائـمـة الـذكـاء الاصـطـنـاعـي 🌐",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 الذكاء الاصطناعي",
"description":"",
"id":"${prefix}aimenu"},
{"header":"قـائـمـة الـجـروب 🫂",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 الجروب",
"description":"",
"id":"${prefix}groupmenu"},
{"header":"قـائـمـة الـمـطـور 👑",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 المطور",
"description":"",
"id":"${prefix}ownermenu"},
{"header":"قـائـمـة الـتـحـويـل 🔃",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 التحويل",
"description":"",
"id":"${prefix}convertmenu"},
{"header":"قـائـمـة الـقـوائـم 📜",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 القوائم",
"description":"",
"id":"${prefix}listmenu"},
{"header":"قـائـمـة الـديـن 🕋",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 الدين",
"description":"",
"id":"${prefix}religionmenu"},
{"header":"قـائـمـة الـنـودز 🔞",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 النودز",
"description":"",
"id":"${prefix}nsfwmenu"},
{"header":"قـائـمـة الانـمـي 🦸🏻‍♂️",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 الانمي",
"description":"",
"id":"${prefix}animemenu"},
{"header":"قـائـمـة الـصـور 🖼️",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 الصور",
"description":"",
"id":"${prefix}randomphotomenu"},
{"header":"قـائـمـة الـفـيـديـو 🎥",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 الفيديو",
"description":"",
"id":"${prefix}randomvideomenu"},
{"header":"قـائـمـة الـسـتـيـكـر 💠",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 استيكر",
"description":"",
"id":"${prefix}stickermenu"},
{"header":"قـائـمـة الـداتـا ⚡",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 الداتا",
"description":"",
"id":"${prefix}databasemenu"},
{"header":"قـائـمـة الـسـتـوري 🐦‍⬛",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 الستوري",
"description":"",
"id":"${prefix}storemenu"},
{"header":"قـائـمـة الـمـطـارد 🌹",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 مطارد",
"description":"",
"id":"${prefix}stalkermenu"},
{"header":"قـائـمـة الـكـراش 📳",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 الكراش",
"description":"",
"id":"${prefix}bugmenu"},
{"header":"قـائـمـة اخـري 🌷",
"title":"امر⇇𝑀𝑉𝑅𝛩 𝐵𝛩𝑇 اخري",
"description":"",
"id":"${prefix}othermenu"}]
}]
}`
